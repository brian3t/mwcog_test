...
function checkCommuteMode(cmode, str) {
    if (cmode.options[cmode.selectedIndex].value == '109' ||
        ...
        document.getElementById("T1L1To").value = "102";
        document.getElementById("T1L2From").value = "0";
        document.getElementById("T1L2To").value = "0";
        document.getElementById("T2L1From").value = "102";
        document.getElementById("T2L1To").value = "101";
        ...
        document.getElementById("T1L2Distance").value = "";
        document.getElementById("T2L2Distance").value = "";
        document.getElementById("T2L1Mode").value = cmode.options[cmode.selectedIndex].value;
        document.getElementById("T1L1Distance").value = document.getElementById("tripDist").value; //"0";
        document.getElementById("T2L1Distance").value = document.getElementById("tripDist").value; //"0";
        document.getElementById("T2L1Mode").disabled = true; //**
        document.getElementById("T1L1Distance").disabled = true;
        document.getElementById("T1L2Distance").disabled = true;
        document.getElementById("T2L1Distance").disabled = true;
        document.getElementById("T2L2Distance").disabled = true;
    } else if (cmode.options[cmode.selectedIndex].value == '111') {
        document.getElementById("T1L1From").value = "101";
        document.getElementById("T1L1To").value = "102";
        document.getElementById("T1L2From").value = "0";
        document.getElementById("T1L2To").value = "0";
        document.getElementById("T2L1From").value = "102";
        ...
        document.getElementById("T2L2To").value = "0";
        document.getElementById("T1L2Mode").value = "0";
        document.getElementById("T2L1Mode").value = "111";
        document.getElementById("T2L2Mode").value = "0";
        ...
        document.getElementById("T1L1Distance").disabled = false;
        document.getElementById("T1L2Distance").disabled = false;
        document.getElementById("T2L1Distance").disabled = false;
        document.getElementById("T2L2Distance").disabled = false;
    }
    return true;
}
