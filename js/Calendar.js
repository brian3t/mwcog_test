...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  // row indicates which day of the week 
  html += TR_days;
  for(i = 0; i < dayArrayShort.length; i++)
    html += TD_days + dayArrayShort[i] + xTD;
  html += xTR;
 
  // start populating the table with days of the month
  html += TR;
  ...
  html += "<button class='dpTodayButton' onClick='updateDateField(\"" + dateFieldName + "\");'><B>Close</B></button>";
  html += xTD + xTR;
